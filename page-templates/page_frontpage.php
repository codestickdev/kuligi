    ...
    <section class="frontAbout">
        <div class="frontAbout__wrap container">
            ...
            <div class="frontAbout__two">
                ...
                <div class="content">
                    <p><b>Jesteśmy oficjalnym, certyfikowanym organizatorem kuligów w Beskidach</b>, co daje Wam pewność najwyższej jakości świadczonych usług przez cały rok. Organizujemy tradycyjne kuligi zimowe na saniach, a wiosną, latem i jesienią - zielone kuligi na pięknie przystrojonych wozach drabiniastych.<br/>Na naszej stronie znajdziecie oferty na kuligi halloween, kuligi andrzejkowe, mikołajkowe, wigilie firmowe z kuligiem, kuligi bożonarodzeniowe, kuligi sylwestrowe, karnawałowe, walentynkowe, feryjne, z okazji dnia kobiet i wiele innych.<br/>Kuligi na naszej stronie pogrupowane są również tematycznie dla wielu grup docelowych takich jak kuligi dla firm, kuligi dla seniorów, kuligi dla szkół i przedszkoli, kuligi rodzinne, kuligi dla singli, kuligi specjalne i wiele innych.Nasze kuligi są niezwykłe, ponieważ obudowane są wielością atrakcji takich jak biesiady z kapelę góralską <b>Karpackie Zbóje</b>, zabawami integracyjnymi z <b>wodzirejem / gawędziarzem</b>, zabawą taneczną z zespołem dancingowo - biesiadnym <b>Folk Zbóje</b>, organizacją profesjonalnego napadu zbójnickiego, pokazem <b>tańca zbójnickiego</b>, dyskotekami z karaoke po góralsku w stylu FOLK POLO z <b>DJ Janosikiem</b>, występem <b>dudziarza</b> na dudach żywieckich lub na gajdach, degustacją regionalnych alkoholi, serów i wędlin i <b>smakołykami kuchni regionalnej</b>, pieczeniem świniaka / dzika / jagnięcia. Wielu klientów życzy sobie samą biesiadę góralską bez kuligu. Tymi atrakcjami zajmuje się grupa <b>GÓRALI i ZBÓJNIKÓW</b>. Jeśli ktoś chciałby wypożyczyć sobie góralski / zbójnicki czy folkowy strój na nasz kulig nie ma problemu!<br/>Zapraszamy do naszej <b>wypożyczalni strojów góralskich.</b></p>
                </div>
            </div>
            <div class="frontAbout__three">
                <div class="content">
                    ...
                    <p>Nowością są wyjazdy na narty na Podhale, w Tatry oraz na termalne źródła do Chochołowa (Termy Chochołowskie), Szaflary (Gorący Potok, Termy Szaflary), Białki Tatrzańskiej (Termy Bania), Bukowiny Tatrzańskiej (Termy Bukovina). Współpracujemy w tym zakresie z licencjonowanym biurem podróży <b>Beskidzkim Centrum Turystyki</b> oraz doświadczonym <b>przewodnikiem beskidzkim</b>.</p>
                    <p>Nasza Firma pomaga również w rezerwacji noclegów w Beskidach a także transportu na kulig z dowolnego miejsca w Polsce dla grup (busy, autokary). Tą działką zajmuje się biuro podróży <b>Żywieckie Centrum Turystyki i Kultury</b>.</p>
